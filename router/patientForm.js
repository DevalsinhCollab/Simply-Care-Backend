...
const { addPatientForm, getPatientsForm, updatePatientForm, deletePatientForm, generateReport, generateCertificate, generateReceipt, generatePrescription, getPatientsFormById, assessmentForm, generateAssessment, getPatientHistory } = require("../controller/patientForm");
const verifyToken = require("../middleware/verifyToken");
const router = express.Router();

router.post("/addpatientform", addPatientForm);
router.get("/getpatientsform", verifyToken ,getPatientsForm);
router.get("/getpatienthistory/:patientId", verifyToken, getPatientHistory);
